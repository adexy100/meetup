...
export const register = ({ email, password, username }: IRegister) =>
  httpRequest<IUser>({
    method: "POST",
    url: "/register",
...
export const logout = () =>
  httpRequest<any>({ method: "DELETE", url: "/logout" });
...
export const deletePost = (postID: string) =>
  httpRequest<IPost>({ method: "DELETE", url: `/post/${postID}` });
...
export const getUser = (username: string) =>
  httpRequest<IUser>({ method: "GET", url: `/${username}` });
...
export const getCommentReplies = (
  params: IFetchParams & { comment_id: string; post_id: string }
) => {
  return httpRequest<IComment[]>({
    method: "GET",
    url: `/reply`,
...
export const followUser = (id: string) =>
  httpRequest<{ state: boolean }>({ method: "POST", url: `/follow/${id}` });

export const unfollowUser = (id: string) =>
  httpRequest<{ state: boolean }>({
    method: "POST",
    url: `/unfollow/${id}`,
  });
...
export const getBookmarks = (params: IFetchParams) =>
  httpRequest<IBookmark[]>({
    method: "GET",
    url: `/bookmarks`,
    params,
  });
...
export const getUnreadMessages = () =>
  httpRequest<{ count: number }>({ method: "GET", url: `/messages/unread` });
