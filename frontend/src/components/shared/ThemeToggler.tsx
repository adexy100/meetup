  ...
  return (
    ...
    >
      <input
        ...
        hidden
      />
      <label htmlFor="theme" className="w-full h-full cursor-pointer">
        <svg viewBox="0 0 512.166 512.166">
          <g>
            <g>
              <path
                d="M503.536,289.135c-6.827-5.227-16.384-5.653-23.829-1.408c-2.219,1.259-4.416,2.539-6.699,3.712
