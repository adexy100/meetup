...
import { IBookmark, IError } from "../../../types/type";
          ...
          <TransitionGroup component={null}>
            {bookmarks.map((item) => (
              <CSSTransition timeout={500} classNames="fade" key={item.id}>
                <div
                  key={item.id}
                  className="h-24 flex justify-between bg-white dark:bg-indigo-1000 rounded-md shadow-lg overflow-hidden"
                >
                    ...
                    <div
                      ...
                      style={{
                        background: `#f7f7f7 url(${
                          item.post.photos[0]?.url || thumbnail
                        })`,
                      }}
                    />
                  </Link>
