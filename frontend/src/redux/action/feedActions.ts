...
export const createPostStart = (post: FormData) =>
  <const>{
    type: CREATE_POST_START,
    payload: post,
  };

export const createPostSuccess = (post: IPost) =>
  <const>{
    type: CREATE_POST_SUCCESS,
    payload: post,
  };

export const updateFeedPost = (post: IPost) =>
  <const>{
...
export const deleteFeedPost = (postID: string) =>
  <const>{
