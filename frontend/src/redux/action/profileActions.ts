...
export const getUserSuccess = (user: IProfile) =>
  <const>{
    type: GET_USER_SUCCESS,
    payload: user,
  };

export const updateProfileInfo = (user: IProfile) =>
  <const>{
    type: UPDATE_PROFILE_INFO,
    payload: user,
  };

export const updateProfilePicture = (image: Object) =>
  <const>{
    type: UPDATE_PROFILE_PICTURE,
    payload: image,
  };

export const updateCoverPhoto = (image: Object) =>
  <const>{
