...
export const minimizeChat = (target: string) =>
  <const>{
    type: MINIMIZE_CHAT,
    payload: target,
  };

export const closeChat = (target: string) =>
  <const>{
    type: CLOSE_CHAT,
    payload: target,
  };

export const getMessagesSuccess = (target: string, messages: IMessage[]) =>
  <const>{
...
export const newMessageArrived = (target: string, message: IMessage) =>
  <const>{
